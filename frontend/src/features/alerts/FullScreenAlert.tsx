/**
 * FullScreenAlert — Helios-Watch Frontend (features/alerts)
 *
 * Floating alert banner shown when M-class or X-class flare is detected.
 * Moved from: components/FullScreenAlert.tsx
 */
...
export const FullScreenAlert: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (currentFlux >= 1e-4) setAlertLevel("X");
    else if (currentFlux >= 1e-5) setAlertLevel("M");
  ...
  return (
    <div className="fixed top-24 left-1/2 -translate-x-1/2 z-50 animate-bounce">
      ...
      <div className="glass-card bg-red-500 bg-opacity-20 border-red-500 text-red-100 px-8 py-4 rounded-xl flex flex-col items-center gap-2 backdrop-blur-md shadow-[0_0_30px_rgba(239,68,68,0.4)]">
